...
Xin chào! Mình là **Lê Quang Minh**, sinh năm **2002**. Hiện tại, mình là sinh viên năm cuối ngành **Công Nghệ Thông Tin** tại Đại học Công nghệ thành phố Hồ Chí Minh (**HUTECH**), dự kiến tốt nghiệp vào tháng 06/2025.
...
### 💼 Dự án tiêu biểu
- **Blog Lập Trình Mạng**: Xây dựng blog cá nhân với Hugo, tích hợp CI/CD với GitHub Actions
- **Hệ thống quản lý thư viện thông minh**: Giải Nhì Hackathon 2024 - ứng dụng quản lý thư viện với tính năng tìm kiếm thông minh
- **Chat Application**: Ứng dụng chat real-time sử dụng WebSocket và Node.js
- **RESTful API Projects**: Các dự án xây dựng API với Spring Boot và Express.js
...
### 🛠️ Frameworks & Tools
- **Spring Boot**: Backend framework cho Java
...
<div class="cert-item">
  <div class="cert-icon">🥈</div>
  <div class="cert-details">
    <h4>Giải Nhì Hackathon 2024</h4>
    <p class="cert-issuer">Đại học HUTECH</p>
    <p class="cert-year">2024</p>
  </div>
</div>
